	<div class="box select admin-box">
		...
		<?php
			echo form_open(SITE_AREA . '/activities/' . $vars['which'], 'class="form-horizontal constrained ajax-form"');
		...
		<div class="form-actions">
			...
			<?php if ($vars['which'] == 'activity_own'): ?>
			...
			<?php elseif ($vars['which'] == 'activity_user'): ?>
			...
			<?php elseif ($vars['which'] == 'activity_module'): ?>
			...
			<?php elseif ($vars['which'] == 'activity_date'): ?>

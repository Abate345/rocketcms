...
$route['404_override'] 					= 'cms/e404';

// Authorization
$route['login']							= 'users/login';
$route['register']						= 'users/register';
$route['logout']						= 'users/logout';
$route['account']						= 'users/profile';
...
// Contexts
$route[SITE_AREA]		= SITE_AREA.'/activities/index';
$route[SITE_AREA .'/([a-z_]+)/(:any)/(:any)/(:any)/(:any)/(:any)']		= SITE_AREA ."/$1/$2/$3/$4/$5/$6";
$route[SITE_AREA .'/([a-z_]+)/(:any)/(:any)/(:any)/(:any)']		= SITE_AREA ."/$1/$2/$3/$4/$5";
$route[SITE_AREA .'/([a-z_]+)/(:any)/(:any)/(:any)']		= SITE_AREA."/$1/$2/$3/$4";
$route[SITE_AREA .'/([a-z_]+)/(:any)/(:any)']		= SITE_AREA ."/$1/$2/$3";
$route[SITE_AREA .'/([a-z_]+)/(:any)']	= SITE_AREA ."/$1/$2";
$route[SITE_AREA .'/([a-z_]+)']			= SITE_AREA."/$1/index";

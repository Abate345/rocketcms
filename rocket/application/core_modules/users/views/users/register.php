<section id="register">
	<div class='sheet'>
		<div class="page-header">
			<h1><?php echo lang('us_register'); ?></h1>
		</div>
				...
				<div class="span12">
					...
					<?php echo form_open('register', array('class' => "form-horizontal", 'autocomplete' => 'off')); ?>
						...
						<div class="control-group <?php echo iif( form_error('display_name') , 'error') ;?>">
							...
							<div class="controls">
								<input class="span6" type="text" name="display_name" id="display_name" placeholder="display name" value="<?php echo set_value('display_name'); ?>" />
							</div>
						</div>
		...
		<div class='content_right'>
			<p style="text-align: center">
				<?php echo lang('us_already_registered'); ?> <?php echo anchor('/login', lang('bf_action_login'), "class='colored'"); ?>
			</p>
		</div>
		<div class='clear'></div>
	</div>

...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="control-group <?php echo form_error('password') ? 'error' : '' ?>">
			<label for="password" class="control-label" <?php if (isset($user)) echo 'style="font-weight:normal;"'; ?> ><?php echo lang('bf_password') ?></label>
			<div class="controls">
		...
		<div class="control-group <?php echo form_error('pass_confirm') ? 'error' : '' ?>">
			<label class="control-label" for="pass_confirm" <?php if (isset($user)) echo 'style="font-weight:normal;"'; ?> ><?php echo lang('bf_password_confirm') ?></label>
			<div class="controls">
		...
		<div class="control-group <?php echo form_error('language') ? 'error' : '' ?>">
			<label class="control-label" for="language" style="font-weight:normal;"><?php echo lang('bf_language') ?></label>
			<div class="controls">
		...
		<div class="control-group <?php echo form_error('timezone') ? 'error' : '' ?>">
			<label class="control-label" for="timezones" style="font-weight:normal;"><?php echo lang('bf_timezone') ?></label>
			<div class="controls">
	...
	<?php if (isset($user) || isset($roles) ) :?>
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="role_id" id="role_id" class="chzn-select" <? if ( $this->uri->segment(4) == 1 ) echo 'disabled="disabled"'; ?> >
		...
		<?php if (isset($user) && $user->id != $this->auth->user_id() && ($user->banned || $user->deleted)) : ?>
		<fieldset>
		...
		<div class="form-actions">
			...
			<?php echo anchor(SITE_AREA .'/users', '<i class="icon-refresh icon-white">&nbsp;</i>&nbsp;' . lang('bf_action_cancel'), 'class="btn btn-warning"'); ?>
		</div>

...
<div class="admin-box">
	...
	<fieldset>
		...
		<!-- Permissions -->
		<? $permission = Roles::permission_options();
		   if($permission){	
		?>
			<fieldset>
		...
		<div class="form-actions">
			<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('role_save_role'); ?>" /> or <?php echo anchor(SITE_AREA .'/roles', lang('bf_action_cancel')); ?>

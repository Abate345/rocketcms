...
<div class="admin-box">
	<h3><?php echo $toolbar_title ?></h3>
		...
		<?php echo form_open(SITE_AREA .'/emailer/template'); ?>
		...
		<div class="form-actions">
			<input type="submit" name="submit" id="submit" class="btn btn-primary" value="Save Template" /> or <?php echo anchor(SITE_AREA .'/emailer', 'Cancel'); ?>
		</div>

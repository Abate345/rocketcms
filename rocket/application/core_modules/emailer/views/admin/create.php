	...
	<table class="table table-striped">
		...
		<tfoot>
			<tr>
				<td colspan="7">
					...
					<?php echo anchor(SITE_AREA .'/emailer/queue', lang('em_create_email_cancel'), 'class="btn btn-warning"'); ?>
				</td>
			</tr>
		</tfoot>
		<?php endif; ?>
		...
		<?php if (isset($users) && is_array($users) && count($users)) : ?>
			...
			<tr>
				...
				<td>
					<a href="<?php echo site_url(SITE_AREA .'/users/edit/'. $user->id); ?>"><?php echo $user->username; ?></a>

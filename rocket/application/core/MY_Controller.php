 ...
 * @copyright Copyright (c) 2011 - 2012, RocketPHP Dev Team
 ...
 * for more detail on the HMVC code used in RocketPHP.
 *
 * @package    RocketPHP\Core\Controllers
...
class Base_Controller extends MX_Controller
{
	...
	public function __construct()
	{
		...
		// Load context to prepare menu rendering. Menu, permissions, etc things that modules need to provide to system for normal work
		$this->contexts->loadEntities();
